...
#Kopierer mal og lagrer ny tom fil
shutil.copy("C:/Prosjekter/NELFO_solcelle/tom_test.xlsx", "C:/Prosjekter/NELFO_solcelle/solcelle_uttrekk.xlsx")
...
for f in range(len(fylke)): #Looper over alle fylkene
    ...
    for kom in range(kom_antall): #Looper gjennom kodelisten for hver kommune
        ...
        if str(fylke[f]) == str(kom_nr[:2]): #Velger kommuner i gitt fylke
            ...
            for kommuneproduksjon in range(len(produksjonstall_kommunenummer)): #Looper gjennom produksjonstallene
                kom_nr_produksjon = produksjonstall_kommunenummer[kommuneproduksjon]
                if str(kom_nr_produksjon) == "301":
                    kom_nr_produksjon = "0301"
                if str(kom_nr_produksjon) == str(kom_nr):  #If som henter produksjonstall avhengig av kommunenummer
            ...
            print("Kommune", kom_nr, " - Regner sammen tall fra GIS-grunnlag")

            for i in range(antall): #Looper gjennom hver rad/bygning i kildedata
                # print("Bygningskode_tekst_to", type(bygningskode_tekst_to))
                # print("Bygningskode_tekst_to[0]", type(bygningskode_tekst_to[0]))
                if kom_nr == 301:
                    kom_nr = "301"
                elif kom_nr == "0301":
                    kom_nr = "301"
            ...
            print("Kommune", kom_nr, " - Utfører mellomregninger")
            ...
            print("Kommune", kom_nr, " - Åpner og lukker excel-fil for å utføre alle formler")

            #Prosess som åpner excel-fil og lagrer igjen. Nødvendig for at formler i mellomregning skal regnes ut.
            ...
            df = df_from_excel("C:/Prosjekter/NELFO_solcelle/excel_calculations/calc_and_inputxlsx.xlsx")


            # #HENTER INN MELLOMREGNING FRA EXCELARK FOR MELLOMREGNING
            print("Kommune", kom_nr, " - Henter inn mellomregninger til skriptet.")
            ...
            print("Kommune", kom_nr, " - Skriver til mal")

            #Excel-fil vi skal skrive data til:
            regneark_test = "C:/Prosjekter/NELFO_solcelle/solcelle_uttrekk.xlsx"
            ...
            final_skriver = wb_test[fylkesnavn] #Setter excel-ark som skal skrives til
            ...
            final_skriver.cell(176,(row+2)).value = kom_navn
            ...
            final_skriver.cell(183,(row+2)).value = kwh_vegg_koie  
            final_skriver.cell(184,(row+2)).value = kwh_vegg_garasje  
            final_skriver.cell(185,(row+2)).value = kwh_vegg_annenbolig  
            final_skriver.cell(186,(row+2)).value = kwh_vegg_industri  
            final_skriver.cell(187,(row+2)).value = kwh_vegg_lager  
            final_skriver.cell(188,(row+2)).value = kwh_vegg_fiskeri  
            final_skriver.cell(189,(row+2)).value = kwh_vegg_kontor  
            final_skriver.cell(190,(row+2)).value = kwh_vegg_forretning  
            final_skriver.cell(191,(row+2)).value = kwh_vegg_messe  
            final_skriver.cell(192,(row+2)).value = kwh_vegg_ekspedisjonsterminal  
            final_skriver.cell(193,(row+2)).value = kwh_vegg_garasjehangar  
            final_skriver.cell(194,(row+2)).value = kwh_vegg_vegtrafikk  
            final_skriver.cell(195,(row+2)).value = kwh_vegg_hotell  
            final_skriver.cell(196,(row+2)).value = kwh_vegg_overnatting  
            final_skriver.cell(197,(row+2)).value = kwh_vegg_restaurant  
            final_skriver.cell(198,(row+2)).value = kwh_vegg_skole  
            final_skriver.cell(199,(row+2)).value = kwh_vegg_universitet  
            final_skriver.cell(200,(row+2)).value = kwh_vegg_museum  
            final_skriver.cell(201,(row+2)).value = kwh_vegg_idrett  
            final_skriver.cell(202,(row+2)).value = kwh_vegg_kultur  
            final_skriver.cell(203,(row+2)).value = kwh_vegg_religios  
            final_skriver.cell(204,(row+2)).value = kwh_vegg_sykehus  
            final_skriver.cell(205,(row+2)).value = kwh_vegg_sykehjem  
            final_skriver.cell(206,(row+2)).value = kwh_vegg_primarhelse  
            final_skriver.cell(207,(row+2)).value = kwh_vegg_beredskap  

            ##########TAK
            final_skriver.cell(213,(row+2)).value = kom_navn
            final_skriver.cell(214,(row+2)).value = kwp_tak_enebolig  #cell[ned, høyre]
            final_skriver.cell(215,(row+2)).value = kwp_tak_tomannsbolig  #cell[ned, høyre]
            final_skriver.cell(216,(row+2)).value = kwp_tak_rekkehus  #cell[ned, høyre]
            final_skriver.cell(217,(row+2)).value = kwp_tak_storeboliger  #cell[ned, høyre]
            final_skriver.cell(218,(row+2)).value = kwp_tak_bofelleskap  #cell[ned, høyre]
            final_skriver.cell(219,(row+2)).value = kwp_tak_fritidsbolig  #cell[ned, høyre]
            final_skriver.cell(220,(row+2)).value = kwp_tak_koie  #cell[ned, høyre]
            final_skriver.cell(221,(row+2)).value = kwp_tak_garasje  #cell[ned, høyre]
            final_skriver.cell(222,(row+2)).value = kwp_tak_annenbolig  #cell[ned, høyre]
            final_skriver.cell(223,(row+2)).value = kwp_tak_industri  #cell[ned, høyre]
            final_skriver.cell(224,(row+2)).value = kwp_tak_lager  #cell[ned, høyre]
            final_skriver.cell(225,(row+2)).value = kwp_tak_fiskeri  #cell[ned, høyre]
            final_skriver.cell(226,(row+2)).value = kwp_tak_kontor  #cell[ned, høyre]
            final_skriver.cell(227,(row+2)).value = kwp_tak_forretning  #cell[ned, høyre]
            final_skriver.cell(228,(row+2)).value = kwp_tak_messe  #cell[ned, høyre]
            final_skriver.cell(229,(row+2)).value = kwp_tak_ekspedisjonsterminal  #cell[ned, høyre]
            final_skriver.cell(230,(row+2)).value = kwp_tak_garasjehangar  #cell[ned, høyre]
            final_skriver.cell(231,(row+2)).value = kwp_tak_vegtrafikk  #cell[ned, høyre]
            final_skriver.cell(232,(row+2)).value = kwp_tak_hotell  #cell[ned, høyre]
            final_skriver.cell(233,(row+2)).value = kwp_tak_overnatting  #cell[ned, høyre]
            final_skriver.cell(234,(row+2)).value = kwp_tak_restaurant  #cell[ned, høyre]
            final_skriver.cell(235,(row+2)).value = kwp_tak_skole  #cell[ned, høyre]
            final_skriver.cell(236,(row+2)).value = kwp_tak_universitet  #cell[ned, høyre]
            final_skriver.cell(237,(row+2)).value = kwp_tak_museum  #cell[ned, høyre]
            final_skriver.cell(238,(row+2)).value = kwp_tak_idrett  #cell[ned, høyre]
            final_skriver.cell(239,(row+2)).value = kwp_tak_kultur  #cell[ned, høyre]
            final_skriver.cell(240,(row+2)).value = kwp_tak_religios  #cell[ned, høyre]
            final_skriver.cell(241,(row+2)).value = kwp_tak_sykehus  #cell[ned, høyre]
            final_skriver.cell(242,(row+2)).value = kwp_tak_sykehjem  #cell[ned, høyre]
            final_skriver.cell(243,(row+2)).value = kwp_tak_primarhelse  #cell[ned, høyre]
            final_skriver.cell(244,(row+2)).value = kwp_tak_beredskap  #cell[ned, høyre]

            final_skriver.cell(249,(row+2)).value = kom_navn
            final_skriver.cell(250,(row+2)).value = kwh_tak_enebolig  
            final_skriver.cell(251,(row+2)).value = kwh_tak_tomannsbolig  
            final_skriver.cell(252,(row+2)).value = kwh_tak_rekkehus  
            final_skriver.cell(253,(row+2)).value = kwh_tak_storeboliger  
            final_skriver.cell(254,(row+2)).value = kwh_tak_bofelleskap  
            final_skriver.cell(255,(row+2)).value = kwh_tak_fritidsbolig  
            final_skriver.cell(256,(row+2)).value = kwh_tak_koie  
            final_skriver.cell(257,(row+2)).value = kwh_tak_garasje  
            final_skriver.cell(258,(row+2)).value = kwh_tak_annenbolig  
            final_skriver.cell(259,(row+2)).value = kwh_tak_industri  
            final_skriver.cell(260,(row+2)).value = kwh_tak_lager  
            final_skriver.cell(261,(row+2)).value = kwh_tak_fiskeri  
            final_skriver.cell(262,(row+2)).value = kwh_tak_kontor  
            final_skriver.cell(263,(row+2)).value = kwh_tak_forretning  
            final_skriver.cell(264,(row+2)).value = kwh_tak_messe  
            final_skriver.cell(265,(row+2)).value = kwh_tak_ekspedisjonsterminal  
            final_skriver.cell(266,(row+2)).value = kwh_tak_garasjehangar  
            final_skriver.cell(267,(row+2)).value = kwh_tak_vegtrafikk  
            final_skriver.cell(268,(row+2)).value = kwh_tak_hotell  
            final_skriver.cell(269,(row+2)).value = kwh_tak_overnatting  
            final_skriver.cell(270,(row+2)).value = kwh_tak_restaurant  
            final_skriver.cell(271,(row+2)).value = kwh_tak_skole  
            final_skriver.cell(272,(row+2)).value = kwh_tak_universitet  
            final_skriver.cell(273,(row+2)).value = kwh_tak_museum  
            final_skriver.cell(274,(row+2)).value = kwh_tak_idrett  
            final_skriver.cell(275,(row+2)).value = kwh_tak_kultur  
            final_skriver.cell(276,(row+2)).value = kwh_tak_religios  
            final_skriver.cell(277,(row+2)).value = kwh_tak_sykehus  
            final_skriver.cell(278,(row+2)).value = kwh_tak_sykehjem  
            final_skriver.cell(279,(row+2)).value = kwh_tak_primarhelse  
            final_skriver.cell(280,(row+2)).value = kwh_tak_beredskap  
            ...
            print("Kommune", kom_nr, " - Skriver til mal - ferdig.\n")

    print("Fylke ferdig. Går til neste\n")
